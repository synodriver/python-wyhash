...
/* Module declarations from 'wyhash.backends.cython' */
...
static PyObject *__pyx_pw_6wyhash_8backends_6cython_7_wyhash_1hash(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_data,&__pyx_n_s_seed,&__pyx_n_s_secret,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_seed)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("hash", 1, 3, 3, 1); __PYX_ERR(0, 9, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_secret)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("hash", 1, 3, 3, 2); __PYX_ERR(0, 9, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "hash") < 0)) __PYX_ERR(0, 9, __pyx_L3_error)
      }
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t__const__(values[0], 0); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_seed = __Pyx_PyInt_As_uint64_t(values[1]); if (unlikely((__pyx_v_seed == ((uint64_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_secret = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t__const__(values[2], 0); if (unlikely(!__pyx_v_secret.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
  }
...
static PyObject *__pyx_pf_6wyhash_8backends_6cython_7_wyhash_hash(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, uint64_t __pyx_v_seed, __Pyx_memviewslice __pyx_v_secret) {
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_secret, 1);
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyBytes_FromStringAndSize(((char *)__pyx_v__wyp), 32); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
...
static PyObject *__pyx_pw_6wyhash_8backends_6cython_7_wyhash_3make_secret(PyObject *__pyx_self, PyObject *__pyx_arg_seed) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("make_secret (wrapper)", 0);
  assert(__pyx_arg_seed); {
    __pyx_v_seed = __Pyx_PyInt_As_uint64_t(__pyx_arg_seed); if (unlikely((__pyx_v_seed == ((uint64_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  __Pyx_AddTraceback("wyhash.backends.cython._wyhash.make_secret", __pyx_clineno, __pyx_lineno, __pyx_filename);
